        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                if (i!=0) return i;
                    ...
                    i=((Date)stock2.get("date")).compareTo((Date)stock1.get("date"));
                    if (i!=0) return i;
                    else
                    {
                        Double price1,price2;
                        if(stock1.containsKey("change")) price1 = (Double)stock1.get("change");
                        else price1=(Double)stock1.get("last")-(Double)stock1.get("open");
                        if(stock2.containsKey("change")) price2 = (Double)stock2.get("change");
                        else price2=(Double)stock2.get("last")-(Double)stock2.get("open");
                        i = price2.compareTo(price1);
                        if(i!=0)return i;
                        else return 0;
                    }
                }
