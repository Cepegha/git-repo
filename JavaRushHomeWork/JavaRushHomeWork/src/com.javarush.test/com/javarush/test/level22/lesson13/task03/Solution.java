...
public class Solution {
    ...
    public static boolean checkTelNumber(String telNumber) {
        ...
        // проверка - на начальный символ и количество цифр
...
/*
    public static void main(String[] args) {
        ...
        System.out.println("050123456"+" false"+" : "+checkTelNumber("050123456"));
        System.out.println("+(012)-12345678-9"+" true"+" : "+checkTelNumber("+(012)-12345678-9"));
        System.out.println("+38(050)12-34-567"+" ?"+" : "+checkTelNumber("+38(050)12-34-567"));
