...
public class Solution
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        while (true)
        {
            ...
            if (_name.isEmpty()) break;
            int _age=Integer.parseInt(reader.readLine());
            int _weight=Integer.parseInt(reader.readLine());;
            int _tailLength=Integer.parseInt(reader.readLine());;

            Cat cat = new Cat(_name,_age,_weight,_tailLength);
            CATS.add(cat);
        }
